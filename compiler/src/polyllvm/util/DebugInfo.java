...
public class DebugInfo {
    ...
    public DebugInfo(LLVMModuleRef mod, LLVMBuilderRef builder, String filePath){
    ...
    private void insertDeclareAtEnd(PseudoLLVMTranslator v, LLVMValueRef alloc, LLVMMetadataRef varMetadata, Position p){
    ...
    public void createParamVariable(PseudoLLVMTranslator v, Formal f, int index, LLVMValueRef alloc) {
        String name = f.name();
    ...
    public void createLocalVariable(PseudoLLVMTranslator v, LocalDecl n, LLVMValueRef alloc) {
        String name = n.name();
    ...
    public void funcDebugInfo(PseudoLLVMTranslator v, ProcedureDecl n, LLVMValueRef funcRef) {
    ...
    public void funcDebugInfo(PseudoLLVMTranslator v, int LineNo, String name, String linkageName, LLVMMetadataRef funcType, LLVMValueRef funcRef) {
        LLVMMetadataRef Unit = createFile();
    ...
    public LLVMMetadataRef debugType(Type t){
        ...
        if(t.isBoolean() || t.isLongOrLess() || t.isFloat() || t.isDouble()){
            ...
            debugType = LLVMDIBuilderCreateArrayType(diBuilder, LLVMUtils.sizeOfType(t), LLVMUtils.sizeOfType(t), debugType(t.toArray().base()), null);
            //debugType = LLVMDIBuilderCreatePointerType(diBuilder, debugType(t.toArray().base()), LLVMUtils.sizeOfType(t), LLVMUtils.sizeOfType(t), "array");
        } else if (t.isClass() ) {
            ...
            debugType = LLVMDIBuilderCreatePointerType(diBuilder, LLVMDIBuilderCreateBasicType(diBuilder, t.toString(), 64, 64, DW_ATE_signed), LLVMUtils.sizeOfType(t)*8, LLVMUtils.sizeOfType(t)*8, "class");
    ...
    private LLVMMetadataRef debugBasicType(Type t) {
        ...
        long numBits = LLVMUtils.sizeOfType(t)*8;
