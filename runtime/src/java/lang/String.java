...
public final class String
    ...
    */
    ...
    public int codePointCount(int beginIndex, int endIndex) {
        ...
        return Character.codePointCountImpl(value,
                                            beginIndex,
                                            endIndex - beginIndex);
    }
    ...
    public int offsetByCodePoints(int index, int codePointOffset) {
        ...
        return Character.offsetByCodePointsImpl(value,
                                                0,
                                                value.length,
                                                index,
                                                codePointOffset);
    ...
    public String toLowerCase(Locale locale) {
        ...
        for (int i = firstUpper; i < len; i += srcCount) {
            ...
            if (localeDependent || srcChar == '\u03A3' || // GREEK CAPITAL LETTER SIGMA
                ...
                lowerChar =
                        ConditionalSpecialCasing.toLowerCaseEx(this, i, locale);
            }
            else {
            ...
            if (lowerChar == Character.ERROR
                ...
                if (lowerChar == Character.ERROR) {
                    lowerCharArray =
                            ConditionalSpecialCasing.toLowerCaseCharArray(this,
                                                                          i,
                                                                          locale);
                }
                else if (srcCount == 2) {
                    resultOffset += Character.toChars(lowerChar,
                                                      result,
                                                      i + resultOffset)
                            - srcCount;
                    continue;
    ...
    public String toUpperCase(Locale locale) {
        ...
        for (int i = firstLower; i < len; i += srcCount) {
            ...
            if (localeDependent) {
                upperChar =
                        ConditionalSpecialCasing.toUpperCaseEx(this, i, locale);
            }
            else {
            ...
            if (upperChar == Character.ERROR
                ...
                if (upperChar == Character.ERROR) {
                    if (localeDependent) {
                        upperCharArray =
                                ConditionalSpecialCasing.toUpperCaseCharArray(this,
                                                                              i,
                                                                              locale);
                    }
                    else {
