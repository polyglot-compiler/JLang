...
jbooleanArray CreateJavaBooleanArray(jint len) { return Polyglot_jlang_runtime_Factory_BooleanArray__I(len); }
jbyteArray    CreateJavaByteArray   (jint len) { return Polyglot_jlang_runtime_Factory_ByteArray__I   (len); }
jcharArray    CreateJavaCharArray   (jint len) { return Polyglot_jlang_runtime_Factory_CharArray__I   (len); }
jshortArray   CreateJavaShortArray  (jint len) { return Polyglot_jlang_runtime_Factory_ShortArray__I  (len); }
jintArray     CreateJavaIntArray    (jint len) { return Polyglot_jlang_runtime_Factory_IntArray__I    (len); }
jlongArray    CreateJavaLongArray   (jint len) { return Polyglot_jlang_runtime_Factory_LongArray__I   (len); }
jfloatArray   CreateJavaFloatArray  (jint len) { return Polyglot_jlang_runtime_Factory_FloatArray__I  (len); }
jdoubleArray  CreateJavaDoubleArray (jint len) { return Polyglot_jlang_runtime_Factory_DoubleArray__I (len); }
jobjectArray  CreateJavaObjectArray (jint len) { return Polyglot_jlang_runtime_Factory_ObjectArray__I (len); }
